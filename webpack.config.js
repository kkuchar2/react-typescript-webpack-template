...
module.exports = {
    ...
    resolve: {
        ...
        alias: {
            ...
            app_redux: resolvePath('src/redux/'),
    ...
    plugins: [
        ...
        new CopyPlugin({
            patterns: [
                {
                    from: resolvePath('assets/images'),
                    to: resolvePath('dist/assets/images'),
                    noErrorOnMissing: true
                },
                {
                    from: resolvePath('assets/translation'),
                    to: resolvePath('dist/assets/translation'),
                    noErrorOnMissing: true
                },
            ],
        }),
